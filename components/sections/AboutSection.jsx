    ...
    <>
      <section id="about" className="max-w-7xl mx-auto my-12 container text-left">
        <div className="relative max-w-4xl mx-auto">
          ...
          <p className="text-xl leading-9">I am studding <span className="text-sky-400">Computer Science</span> from <span className="text-sky-400">ILMA University</span>, I am also working an with engineering team at <span className="text-sky-400">A2Z Creatorz</span> as a software developer where I am working on a wide variety of interesting and meaningful projects on a daily basis.</p>
